<?php get_header(); ?>
    ...
    <section class="l-products__page">
        <div class="p-products__categories">
            <div class="p-products__category is-active"><a href="<?php echo get_post_type_archive_link('products'); ?>">すべて</a></div>
            <?php $genre_terms = get_terms('genre', array('hide_empty' =>false)); ?>
            <?php foreach($genre_terms as $genre_term) : ?>
                <div class="p-products__category"><a href="<?php echo get_term_link($genre_term, 'genre'); ?>"><?php echo $genre_term->name; ?></a></div>
            <?php endforeach; ?>
        </div>
