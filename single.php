...
<div class="l-mv p-mv">
        ...
        <div class="l-mv__content-area--child p-mv__content-area">
            ...
            <p class="p-mv__read-sub--child l-mv__read-sub--child">ブログ</p>
        </div>
        <!-- /.p-mv__content-area -->
    </div>
		<!-- / .l-mv -->
            ...
            <?php if(have_posts()) : ?>
                ...
                <div class="p-entry l-entry-main__content">
                    <div class="p-entry__label">
                        ...
                        ?>
                        <?php if ($category[0]) : ?>
                        <div class="c-entry-label"><a href="<?php echo get_category_link($category[0]->term_id); ?>"><?php echo $category[0]->name; ?></a></div>
                        <?php endif; ?>
                    </div>
